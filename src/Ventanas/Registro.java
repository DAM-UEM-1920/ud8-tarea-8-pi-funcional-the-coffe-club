			...
			public void keyReleased(KeyEvent e) {
				...
				if (e.getKeyCode() == KeyEvent.VK_ENTER) {
					if (txtPasswordUser.getText().length() == 0) {
						...
						miControlador.SoundLogAtras();
						lblResultado_pass.setText("Introduce una contrase�a valida");
				...
				if (e.getKeyCode() == KeyEvent.VK_ENTER) {
					...
					if (txtPasswordUser.getText().equals(txtPasswordConfirmar.getText())) {
						...
						if (txtPasswordConfirmar.getText().length() == 0) {
							...
							miControlador.SoundLogAtras();
							lblResultado_ConfirmarPass.setText("Introduce una contrase�a valida");
						...
						miControlador.SoundLogAtras();
						lblResultado_ConfirmarPass.setText("La contrase�as no coinciden");
					}
 ...
 public void aniadir() {
		 ...
		 if (usr.length()!=0&&passwd.length()!=0&&email.length()!=0) {
			 if (DNI.length()!=0&&passwd.equals(rppasswd)) {
				...
				lblResultado.setForeground(Color.YELLOW);
				lblResultado.setText("La Contrase�a no coincide ");
			}
