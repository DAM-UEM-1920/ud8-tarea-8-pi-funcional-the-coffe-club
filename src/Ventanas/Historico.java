...
public class Historico {
	...
	private void initialize() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(Historico.class.getResource("/Img/UEM-simbolo.jpg")));
		...
		lblLogoBoton.setIcon(new ImageIcon(Historico.class.getResource("/Img/LoUEBoton.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(Historico.class.getResource("/Img/Fondogrande.jpg")));
